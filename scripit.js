...
const formatador = (data) => {
  ...
  const atividade = {
    name: "Full-Stack",
    date: new Date("2024-06-22 19:00"),
    finalizada: true
  }
  
  //lista, array, vetor [a0, b1, c2]
  let atividades = [
    atividade, 
    {
      name: 'Rocketseat (°5Anos)',
      date: new Date ("2024-05-08 19:00"),
      finalizada:true
    },
    {
      name: 'GO',
      date: new Date ("2024-07-08 19:00"),
      finalizada:true
    },
  ]
    ...
    return `
      <div class="card-bg">
        ...
        <div>
          ...
          <svg class="active" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <svg class="inactive"xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
  ...
  const concluirAtividade = (event) => {
    ...
    const dataDestaqueInput = input.value
  
    const atividade = atividades.find((atividade) =>{
      return atividade.date == dataDestaqueInput
    })
